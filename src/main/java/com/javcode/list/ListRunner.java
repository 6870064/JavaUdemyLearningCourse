...
public class ListRunner {
        ...
        while (param != 0) {
            switch (param) {
                case 1:
                    ...
                    System.out.println("Please enter an action by typing [0-6]");
    ...
    private static void printOut() {
        System.out.println("Please choose an action. Click : \n"
                + "1 to add a nw item into ToDoList \n"
                + "2 to print out the list \n"
                + "3 to update an existing item \n"
                + "4 to remove an item form the lust \n"
